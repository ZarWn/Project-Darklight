...
public class LevelUpManager : MonoBehaviour
{
    ...
    // YENİ: Kartların içindeki boş çerçeveleri buraya sürükleyeceğiz
    ...
    private string[] descs = { 
        ...
        "Maksimum Can sınırını %20 artırır.", 
        ...
        "+1 Zırh verir ve Maksimum Canı %10 artırır.", 
        "Altın kazancını %40 artırır ama Maksimum Canı %15 düşürür.", 
        "Saldırılara +4 Ateş Hasarı ve +2 Normal Hasar ekler.",
        "Maksimum canın %30'unu yeniler ve +%8 Can Çalma ihtimali verir."
    };
    
    [Header("Yetenek İkonları (İsimlerle Aynı Sırada Ekleyin)")]
    ...
    void SelectRandomAbilities()
    {
        ...
        for (int i = 0; i < 3; i++) 
        {
            ...
            if (cardIcons[i] && icons.Length > selectedIndexes[i]) 
            {
                cardIcons[i].sprite = icons[selectedIndexes[i]];
            }
        }
    }
    ...
    void ApplyAbility(int index)
    {
        ...
        switch (index)
        {
            ...
            case 14: // Açgözlü Tüccar
                ...
                // Mevcut canı yeni sınıra göre ayarla
